...
public class ItemClaybit extends Item{
	...
	public ItemClaybit() {
		setUnlocalizedName(RDTReference.RDTItems.CLAYBIT.getUnlocalisedName());
		setRegistryName(RDTReference.RDTItems.CLAYBIT.getRegistryName());
