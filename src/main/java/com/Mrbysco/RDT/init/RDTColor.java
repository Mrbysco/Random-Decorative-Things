...
public class RDTColor {
	...
	public static void registerColourHandlers() {
		...
		System.out.println("Color registered for " + ":" + RDTBlocks.villagebutcher.getUnlocalizedName());
	}
	...
	private static void registerBlockColourHandlers(final BlockColors blockColors) {
		...
		blockColors.registerBlockColorHandler(grassColourHandler, RDTBlocks.villagebutcher);
	}
	...
	private static void registerItemColourHandlers(final BlockColors blockColors, final ItemColors itemColors) {
		...
		itemColors.registerItemColorHandler(itemBlockColourHandler, RDTBlocks.villagebutcher);
}
}